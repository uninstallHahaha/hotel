...
<div id="sitecontent">
    <div id="newsPage" class="npagePage Pagenews">
        ...
        <div class="content">
            ...
            <div id="category">
                <a href="#" onclick="triggle(0)" id="b0"  class='active' >全部</a>
                <a href="#"  onclick="triggle(1)" id="b1">主餐服务</a>
                <a href="#"  onclick="triggle(2)" id="b2">酒水服务</a>
                <a href="#"  onclick="triggle(3)" id="b3">其他服务</a>

            </div>
            <div id="newslist">
                <div class="wrapper" id="listWrapper">
