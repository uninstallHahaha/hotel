...
<div id="header">
    <div class="content"><a href="../../index.html" tppabs="http://dede24.va666.com/" id="logo"><img
        ...
        <ul id="nav">
            ...
            <li class="navitem"><a class='active' href="/getWineList/0">酒水
            </a>
                <ul class="subnav">
    ...
    <div class="npagePage Pageanli" id="mproject">
        <div class="content">
            <div class="header" id="plheader">
                <p class="title">酒水 - 列表</p>
                <p class="subtitle">PRODUCTS</p>
            </div>
            <ul id="category">
                <li><a href="/getWineList/0" class='${type==0?'active':''}'>全部</a>
                </li>

                <li><a href="/getWineList/1" class='${type==1?'active':''}'>餐前酒</a></li>

                <li><a href="/getWineList/2" class='${type==2?'active':''}'>佐餐酒</a></li>

                <li><a href="/getWineList/3" class='${type==3?'active':''}'>餐后酒</a></li>

                <li><a href="/getWineList/4" class='${type==4?'active':''}'>饮料</a></li>
