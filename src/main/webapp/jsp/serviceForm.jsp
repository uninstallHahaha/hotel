                        ...
                        <div class="baseinfo">
                            ...
                            <form class="layui-form" action="">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="serviceType" id="serviceType" lay-filter="aihao">
                                            <option value="1">主餐服务</option>
                                            <option value="2">酒水服务</option>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="room" id="room" lay-filter="aihao">
                                            ...
                                            <option value="1">2号餐桌</option>
                                            <option value="1">3号餐桌</option>
                                            <option value="1">4号餐桌</option>
                                            <option value="1">5号餐桌</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea id="beizhu"
                                                  value="无"
                                                  placeholder="请输入具体事项" class="layui-textarea beizhu"></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="checkoutBtn" id="checkoutBtn">呼叫服务</div>
                    </div>
...
<link rel="stylesheet" type="text/css" href="/xgather/xcss/serviceForm.css">
...
<script src="/xgather/xjs/serviceForm.js"></script>
